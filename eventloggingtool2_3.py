#!/usr/bin/env python3
# Script: Ops 401 Class 26 Event Logging Tool Part 2 of 3
# Author: Zachary Derrick                    
# Date of latest revision:  11/08/22    
# Purpose: Continuation of event logging tool. Add a log rotation feature based on size.
...
def rotating_timed_log(log_filename):
    ...
    handler = TimedRotatingFileHandler(log_filename, when="m", interval = 1, backupCount=5)
